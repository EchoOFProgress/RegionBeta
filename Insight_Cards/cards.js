 ...
 * All card content is stored here to avoid CORS/Fetch issues when loading locally.
 */
...
const INSIGHT_CARDS = [
    {
        ...
        "sources": [
            { "type": "📄", "name": "NORCROSS, John C., VANGARELLI, Dominic J. The resolution solution: longitudinal examination of New Year's change attempts. Journal of Substance Abuse, 1988.", "links": [ { "label": "PubMed", "url": "https://pubmed.ncbi.nlm.nih.gov/2980864/" }, { "label": "ScienceDirect", "url": "https://www.sciencedirect.com/science/article/abs/pii/S0899328988800166" } ] },
            { "type": "🎙️", "name": "Dr. K (HealthyGamerGG) – Why New Year's Resolutions Don't Work (podcast, leden 2022)", "links": [ { "label": "Spotify", "url": "https://open.spotify.com/episode/0VELmAsJ9ULbQDu5HGFlo0" } ] }
        ],
        "triggers": [
    ...
    },
    {
        ...
        "sources": [
            { "type": "📄", "name": "MATTHEWS, Gail. The Impact of Commitment, Accountability, and Written Goals on Goal Achievement. Dominican University of California, 2007.", "links": [ { "label": "Originální výzkum (PDF)", "url": "https://www.dominican.edu/sites/default/files/2020-02/gailmatthews-harvard-goals-researchsummary.pdf" }, { "label": "Dominican University (abstrakt)", "url": "https://scholar.dominican.edu/psychology-faculty-conference-presentations/3/" } ] },
            { "type": "🏛️", "name": "Yale/Harvard Libraries – Oficiální vyjádření k neexistenci původní studie.", "links": [ { "label": "Yale FAQ", "url": "https://ask.library.harvard.edu/faq/82314" } ] },
            { "type": "📰", "name": "RapidBI – Fact or fiction? The written goals study.", "links": [ { "label": "Investigace", "url": "https://rapidbi.com/harvard-yale-written-goals-study-fact-or-fiction/" } ] },
            { "type": "✍️", "name": "Sid Savara – Harvard Study: Truth revealed.", "links": [ { "label": "Ověření článku", "url": "https://sidsavara.com/fact-or-fiction-the-truth-about-the-harvard-written-goal-study/" } ] }
        ],
        "triggers": [
    ...
    },
    {
        ...
        "sources": [
            { "type": "📘", "name": "ALLEN, David. Getting Things Done: The Art of Stress-Free Productivity.", "links": [ { "label": "Pravidlo dvou minut (James Clear)", "url": "https://jamesclear.com/how-to-stop-procrastinating" }, { "label": "Web autora", "url": "https://gettingthingsdone.com/2020/05/the-two-minute-rule-2/" } ] }
        ],
        "triggers": [
    ...
    },
    {
        ...
        "sources": [
            { "type": "📘", "name": "CLEAR, James. Atomic Habits. Avery, 2018.", "links": [ { "label": "Shrnutí autorových zákonů", "url": "https://jamesclear.com/atomic-habits-summary" }, { "label": "Jak přestat prokrastinovat", "url": "https://jamesclear.com/how-to-stop-procrastinating" } ] }
        ],
        "triggers": [
    ...
    },
    {
        ...
        "sources": [
            { "type": "🎙️", "name": "BARTLETT, Steven — Modern Wisdom Podcast s Chrisem Williamsonem, ep. #688", "links": [ { "label": "YouTube", "url": "https://www.youtube.com/watch?v=JBgwF8aHByI" } ] },
            { "type": "📘", "name": "BARTLETT, Steven. The Diary of a CEO: 33 Laws of Business and Life. 2023.", "links": [] }
        ],
        "triggers": [
